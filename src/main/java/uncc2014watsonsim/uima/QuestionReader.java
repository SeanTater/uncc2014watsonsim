...
public class QuestionReader extends CollectionReader_ImplBase {
  ...
  private static final String COMPONENT_ID = "QuestionReader";
  ...
  public void initialize() throws ResourceInitializationException {
    ...
    try {
      ...
      while ((line = cin.readLine()) != null) {
        ...
        queries.add(query);
        if (DEBUG)
          System.err.println("QuestionReader UIMA read query: " + query);
      }
      cin.close();
    } catch (IOException e) {
  ...
  public static CollectionReaderDescription getDescription() throws InvalidXMLException {
    InputStream descriptorStream = QuestionReader.class
            .getResourceAsStream("QuestionReader.xml");
