 ...
 * It uses c-style programming in order to avoid memory overhead. The
 * expectation is that there will be many tags. Iteration and such probably
 * aren't any faster and we didn't profile to see.
 * 
